...
def get_args_parser():
    project_name='compare/add/promptsam_2'
    ...
    parser.add_argument('--lr_start', default=3.5e-4, type=int)
   ...
   # * Project parameters
    ...
    # * SAM parameters
    parser.add_argument('--model_type', default='vit_promptsam', type=str)
...
def main(args):
    ...
    elif args.model_type == 'vit_promptsam':
    ...
    model_dir = '/zbssd/yuyu/code/Domain_torch/weights/compare/add/promptsam_1/SAM_epo23_tacc0.9915_vacc0.8268_vmiou0.5900.pth'
    ...
    for k in state_dict.keys():
        if k in Model.state_dict().keys() and 'prompt_encoder' not in k:
    ...
    train_dataset = huanghe_dataset(map_dir=args.train_map, map_seffix=args.map_seffix, label_dir=args.train_label, label_seffix=args.label_seffix, is_index=False, is_train=True)

    val_dataset = huanghe_dataset(map_dir=args.val_map, map_seffix=args.label_seffix, label_dir=args.val_label, label_seffix=args.label_seffix, is_index=False, is_train=True)
...
def pred_pic(args):
    ...
    model_dir = '/zbssd/yuyu/code/Domain_torch/weights/compare/2022/promptsam/promptsam_1/SAM_epo23_tacc0.9964_vacc0.9295_vmiou0.7077.pth'
    ...
    cv2.imwrite("/zbssd/yuyu/code/Domain_torch/picture_4/2022/promptsam2022.png", segmented_image)
