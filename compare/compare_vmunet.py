...
def get_args_parser():
    project_name='compare/2021/vmunet'
   ...
   # * Project parameters
    ...
    parser.add_argument('--model_name', default='vmunet', type=str)
...
def main(args):
    Model = VMUNet(input_channels=args.n_channels, num_classes=args.n_class)
    optimizer, lr_scheduler = prepare_training(args, Model)
    # model_dir = '/zbssd/yuyu/code/Domain_torch/weights/compare/2022/yhvmunet_epo94_tacc0.9572_vacc0.8454_vmiou0.5467.pth'
