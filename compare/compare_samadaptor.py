...
def get_args_parser():
    project_name='compare/2022/samadaptor/samadaptor_1'
    ...
    parser.add_argument('--n_class', default=8, type=int) #8
   ...
   # * Project parameters
    ...
    # * SAM parameters
    parser.add_argument('--model_type', default='vit_samadaptor', type=str)
...
def train(epo, model, train_loader, optimizer, loss_scaler, args):
    ...
    for it, (images, labels, names) in enumerate(train_loader):
        ...
        with torch.cuda.amp.autocast(dtype=torch.bfloat16):
            ...
            loss_all = ce_criterion(logits1, labels)
...
def main(args):
    ...
    elif args.model_type == 'vit_samadaptor':
        model_checkpoint = './model/sam/weight/efficient_sam_vits.pt'
...
def pred_pic(args):
    ...
    model_dir = '/zbssd/yuyu/code/Domain_torch/weights/compare2021/autosam/autosam_1/SAM_epo80_tacc0.9588_vacc0.9067_vmiou0.7333.pth'
    ...
    cv2.imwrite("/zbssd/yuyu/code/Domain_torch/picture/autosamadd.png", segmented_image)
